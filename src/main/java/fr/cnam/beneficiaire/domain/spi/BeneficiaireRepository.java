package fr.cnam.beneficiaire.domain.spi;
...
public interface BeneficiaireRepository {
     ...
     * @return Le nombre de {@link Beneficiaire} modifié
     *
     */
    int updateBeneficiaire(Beneficiaire beneficiaire);
     ...
     *
     */
    int updateBeneficiaire(Long id, Beneficiaire beneficiaire);
     ...
     */
    boolean deleteBeneficiaire(String matricule, LocalDate dateNaissance, int rang);
