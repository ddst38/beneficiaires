 ...
 * - toutes celles de javax.validation.constraints: {@link NotNull}, {@link NotEmpty}, {@link Size}...<br>
...
public interface BeneficiaireService {
    ...
    /**
     * Supprime le {@link Beneficiaire} correspondant au tuple <code>matricule</code> / <code>dateNaissance</code> / <code>rang</code>.
     *
     * @param matricule Le matricule du bénéficiaire
     * @param dateNaissance La date de naissance du bénéficiare
     * @param rang Le rang du bénéficiaire
